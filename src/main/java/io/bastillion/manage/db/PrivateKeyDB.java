    ...
    public static ApplicationKey getApplicationKey() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                appKey.setPassphrase(EncryptionUtil.decrypt(rs.getString("passphrase").trim()));
                appKey.setPrivateKey(EncryptionUtil.decrypt(rs.getString("private_key").trim()));
                appKey.setPublicKey(rs.getString("public_key").trim());
